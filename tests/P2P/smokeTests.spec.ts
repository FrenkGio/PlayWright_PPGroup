...
myTest("User navigates to the settings page and adjusts a permission for a role ", async ({ pageP2P }) => {
    ...
    await pageP2P.locator("#formly_3_input_name_0").waitFor()
    await expect(pageP2P.locator("#formly_3_input_name_0")).toBeVisible()
    await pageP2P.locator("#formly_3_multiSelect_permissions_2 .form-element").waitFor()
    await expect(pageP2P.locator("#formly_3_multiSelect_permissions_2 .form-element")).toBeVisible()
    await pageP2P.locator("#formly_3_multiSelect_permissions_2 .form-element").click()
    await pageP2P.locator(genericFilters.dropdownField.DropdownSearchEntryField).fill(searchPermission, { delay: 500 })
